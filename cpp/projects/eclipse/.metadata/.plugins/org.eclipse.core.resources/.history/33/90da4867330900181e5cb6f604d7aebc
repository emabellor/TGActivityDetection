...
// Producer
DEFINE_string(image_path,               "/home/mauricio/Builds/openpose/examples/media/COCO_val2014_000000000192.jpg",     "Process the desired image.");
// OpenPose
DEFINE_string(model_pose,               "COCO",         "Model to be used. E.g. `COCO` (18 keypoints), `MPI` (15 keypoints, ~10% faster), "
                                                        "`MPI_4_layers` (15 keypoints, even faster but less accurate).");
DEFINE_string(model_folder,             "/home/mauricio/Builds/openpose/models/",      "Folder path (absolute or relative) where the models (pose, face, ...) are located.");
...
int main() {
    int a = 3;
    std::cout << a << std::endl;
    op::log("Initializing main function!");
    DetectPoses();
