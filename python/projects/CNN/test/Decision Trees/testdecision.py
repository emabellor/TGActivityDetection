...
Copied from https://github.com/random-forests/tutorials/blob/master/decision_tree.ipynb

Only has training implementeda
"""
...
def main():
    ...
    # Demo function for unique_values function
    ...
    # Generation of elements in the list
    true_rows, false_rows = partition(training_data, Question(0, 'Green'))
    gain = info_gain(true_rows, false_rows, current_uncertainty)

    print(gain)

    # Find first best question
    ...
    print('Done generating decision tree')
