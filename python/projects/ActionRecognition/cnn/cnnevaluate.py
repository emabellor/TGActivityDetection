...
def main():
    """Main function"""
    print('Initializing main function - Evaluation')

    print('Loading data')
    file_dir = '/home/mauricio/folderdueval'
    ...
    print(labels)
    # Get Results!
    predict_results = activity_classifier.predict(input_fn=eval_input_fn)
    for x, each in enumerate(predict_results):
        print(each)

    eval_results = activity_classifier.evaluate(input_fn=eval_input_fn)
    print(eval_results)
